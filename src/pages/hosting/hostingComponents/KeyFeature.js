    ...
    <div className='bg-[#facc15] section-margin py-28'>
        ...
        <div className='grid grid-cols-3 md:grid-flow-row gap-6'>
            <div className='hosting-feature-box'>
                ...
                <p>Easily enhance your website with over 400 one-click applications through Softaculous. Whether it's a blog, e-commerce platform, or content management system, you can install them effortlessly.</p>
            </div>
            <div className='hosting-feature-box'>
